<template>
  <div class="max-w-7xl mx-auto relative overflow-hidden bg-white py-2">
    <div
    ...
    <div class="relative px-6 lg:px-8">
      <div class="mx-auto max-w-prose text-lg">
        <h1 class="block text-left text-3xl font-bold text-gray-700 p-4">
          AIS CLarity Project
        </h1>
      </div>
      <div class="prose prose-lg prose-teal mx-auto mt-6 text-gray-500">
        <p>
        ...
        <p>
          ...
          quam varius orci dapibus volutpat cras. In amet eu ridiculus leo sodales cursus
          tristique. Tincidunt sed tempus ut viverra ridiculus non molestie. Gravida quis
          fringilla amet eget dui tempor dignissim. Facilisis auctor venenatis varius
