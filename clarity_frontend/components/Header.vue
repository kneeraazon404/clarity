<template>
  <Popover class="relative bg-white">
    <div class="mx-auto max-w-7xl px-6">
      <div
        class="flex items-center justify-between py-6 md:justify-start md:space-x-10 shadow-none px-4"
      >
        ...
        <div class="-my-2 -mr-2 md:hidden">
          <PopoverButton
            class="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-800"
          >
                  ...
                  <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    ...
                    >
                      ...
                      <div class="ml-4">
                        ...
                        <p class="mt-1 text-sm text-gray-800">{{ item.description }}</p>
                      </div>
                    </a>
                  </div>
                  <div
              ...
              >
                ...
                >
                  ...
                  <div class="bg-gray-50 px-5 py-5 sm:px-8 sm:py-8">
                    <div>
                      <h3 class="text-base font-medium text-gray-800">Recent Posts</h3>
                    ...
                    <div class="mt-5 text-sm">
                      <a href="#" class="font-medium text-teal-600 hover:text-teal-800">
                        View all posts
