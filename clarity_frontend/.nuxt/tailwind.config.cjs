module.exports = {
  ...
  "content": {
    ...
    "files": [
      ...
      "./plugins/**/*.{js,ts}",
      "./nuxt.config.{js,ts}",
      "/home/kneeraazon/Clarity/clarity_frontend/components/**/*.{vue,js,ts}",
      "/home/kneeraazon/Clarity/clarity_frontend/layouts/**/*.vue",
      "/home/kneeraazon/Clarity/clarity_frontend/pages/**/*.vue",
      "/home/kneeraazon/Clarity/clarity_frontend/composables/**/*.{js,ts}",
      "/home/kneeraazon/Clarity/clarity_frontend/plugins/**/*.{js,ts}",
      "/home/kneeraazon/Clarity/clarity_frontend/App.{js,ts,vue}",
      "/home/kneeraazon/Clarity/clarity_frontend/app.{js,ts,vue}",
      "/home/kneeraazon/Clarity/clarity_frontend/Error.{js,ts,vue}",
      "/home/kneeraazon/Clarity/clarity_frontend/error.{js,ts,vue}"
    ],
    "extract": {},
    "transform": {}
