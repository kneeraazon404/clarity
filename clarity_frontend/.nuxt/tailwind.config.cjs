module.exports = {
  ...
  "content": {
    ...
    "files": [
      ...
      "./plugins/**/*.{js,ts}",
      "./nuxt.config.{js,ts}",
      "/home/kneeraazon/clarity_frontend/components/**/*.{vue,js,ts}",
      "/home/kneeraazon/clarity_frontend/layouts/**/*.vue",
      "/home/kneeraazon/clarity_frontend/pages/**/*.vue",
      "/home/kneeraazon/clarity_frontend/composables/**/*.{js,ts}",
      "/home/kneeraazon/clarity_frontend/plugins/**/*.{js,ts}",
      "/home/kneeraazon/clarity_frontend/App.{js,ts,vue}",
      "/home/kneeraazon/clarity_frontend/app.{js,ts,vue}",
      "/home/kneeraazon/clarity_frontend/Error.{js,ts,vue}",
      "/home/kneeraazon/clarity_frontend/error.{js,ts,vue}"
    ],
    "extract": {},
    "transform": {}
