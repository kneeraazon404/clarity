...
import { unref, withCtx, createVNode, createTextVNode, resolveDynamicComponent, openBlock, createBlock, Fragment, renderList, toDisplayString, Transition, useSSRContext, defineComponent, h, mergeProps } from "vue";
import { Popover, PopoverButton, PopoverGroup, PopoverPanel } from "@headlessui/vue";
import { Bars3Icon, XMarkIcon, ChartBarIcon, CursorArrowRaysIcon, ShieldCheckIcon, Squares2X2Icon, ArrowPathIcon, PlayIcon, PhoneIcon, LifebuoyIcon, BookmarkSquareIcon, CalendarIcon } from "@heroicons/vue/24/outline";
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul></div></div></div></div><div class="mt-16 border-t border-gray-900/20 pt-8 sm:mt-20 lg:mt-24"><p class="text-xs leading-5 text-gray-500"> © 2023 AIS Clarity, All rights reserved. </p></div></div></footer><!--]-->`);
    };
  }
};
...
//# sourceMappingURL=default-be9d28bd.js.map
