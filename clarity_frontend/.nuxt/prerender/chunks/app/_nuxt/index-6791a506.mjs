import { ref, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, withDirectives, vModelCheckbox, useSSRContext } from 'file:///home/kneeraazon/clarity_frontend/node_modules/vue/index.mjs';
import { _ as _export_sfc } from '../server.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderClass } from 'file:///home/kneeraazon/clarity_frontend/node_modules/vue/server-renderer/index.mjs';
import { TransitionRoot, Dialog, TransitionChild, DialogPanel, Disclosure, DisclosureButton, DisclosurePanel } from 'file:///home/kneeraazon/clarity_frontend/node_modules/@headlessui/vue/dist/headlessui.esm.js';
import { XMarkIcon } from 'file:///home/kneeraazon/clarity_frontend/node_modules/@heroicons/vue/24/outline/index.js';
import { ChevronDownIcon, PlusIcon } from 'file:///home/kneeraazon/clarity_frontend/node_modules/@heroicons/vue/20/solid/index.js';
import { _ as _sfc_main$2 } from './FlatCardsWithDividers-ae219192.mjs';
...
import './CompanyStore-da34e7fa.mjs';

const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><div class="py-4"><h1 class="font-bold pb-2 text-2xl text-gray-800">AIS Clarity Project</h1><p> Assumenda, voluptatem iure nostrum, ea quasi quis consectetur temporibus unde velit consequatur, perspiciatis voluptatum illo! Quam numquam cum rerum consequatur tempora facere, qui quae dolorum similique iure ullam placeat ipsa et! Facere, in atque autem enim eveniet incidunt eum repellendus pariatur quibusdam assumenda voluptate beatae vel nemo eos velit ipsum. </p><br><p> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Natus laborum labore ipsam officia? Vero quibusdam distinctio ipsum repudiandae, dolores unde ab suscipit dicta a voluptates earum libero nulla cumque aliquid! </p></div><br><hr><!--]-->`);
}
...
const __default__ = {
  components: {
    FlatCardsWithDividers: _sfc_main$2
  },
  setup() {
    return {
      checkedValues
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">`);
      _push(ssrRenderComponent(_component_Hero, null, null, _parent));
      _push(`<div class="lg:grid lg:grid-cols-3 lg:gap-x-8 xl:grid-cols-4"><aside><h2 class="sr-only">Filters</h2><button type="button" class="inline-flex items-center lg:hidden"><span class="text-lg font-medium text-gray-700 py-4">Filters</span>`);
      ...
      _push(ssrRenderComponent(_sfc_main$2, { checkedValues: checkedValues2.value }, null, _parent));
...
//# sourceMappingURL=index-6791a506.mjs.map
